...
/**
 * The {@code FeedsNotFoundException} class represents an exception that is thrown when a request to retrieve feeds
 * results in a "Gone" HTTP status (HTTP 410). This exception typically indicates that the requested feeds or resource
...
public class FeedsNotFoundException extends RuntimeException {
}
